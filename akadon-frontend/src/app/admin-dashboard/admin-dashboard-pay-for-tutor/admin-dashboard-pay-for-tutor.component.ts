...
@Component({
  selector: 'app-admin-dashboard-pay-for-tutor',
  templateUrl: './admin-dashboard-pay-for-tutor.component.html',
  styleUrls: ['./admin-dashboard-pay-for-tutor.component.css'],
})

export class AdminDashboardPayForTutorComponent implements OnInit {
  constructor(
