...
import { CityCheck, DistrictCheck, WardCheck, GenderCheck, TutorCodeCheck, TutorCodeCheckTimeOut } from 'src/app/validator';
import { TutorEmailCheck, TutorPhoneNumberCheck } from 'src/app/validator';
import { ConfirmedValidator, NumberValidator, SpecialValidator, TransformValidator } from 'src/app/validator';
import { SubjectCheck } from 'src/app/validator';

import { TutorDetail } from 'src/app/models/tutor-detail.model';
